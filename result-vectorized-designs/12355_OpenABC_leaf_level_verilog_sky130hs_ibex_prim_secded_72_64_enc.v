...
module prim_secded_72_64_enc(	// /tmp/tmp.cTktmlahZ8/12355_OpenABC_leaf_level_verilog_sky130hs_ibex_prim_secded_72_64_enc.cleaned.mlir:2:3
  input  [63:0] in,	// /tmp/tmp.cTktmlahZ8/12355_OpenABC_leaf_level_verilog_sky130hs_ibex_prim_secded_72_64_enc.cleaned.mlir:2:39
  output [71:0] out	// /tmp/tmp.cTktmlahZ8/12355_OpenABC_leaf_level_verilog_sky130hs_ibex_prim_secded_72_64_enc.cleaned.mlir:2:54
);

  wire _GEN = in[0] ^ in[1] ^ in[2] ^ in[3] ^ in[4] ^ in[5];	// /tmp/tmp.cTktmlahZ8/12355_OpenABC_leaf_level_verilog_sky130hs_ibex_prim_secded_72_64_enc.cleaned.mlir:3:10, :4:10, :5:10, :6:10, :7:10, :8:10, :67:11
  assign out =
