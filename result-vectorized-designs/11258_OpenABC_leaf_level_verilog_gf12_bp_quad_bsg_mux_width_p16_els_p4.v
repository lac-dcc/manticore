...
module bsg_mux_width_p16_els_p4(	// /tmp/tmp.5zXO9qCSQw/11258_OpenABC_leaf_level_verilog_gf12_bp_quad_bsg_mux_width_p16_els_p4.cleaned.mlir:2:3
  input  [63:0] data_i,	// /tmp/tmp.5zXO9qCSQw/11258_OpenABC_leaf_level_verilog_gf12_bp_quad_bsg_mux_width_p16_els_p4.cleaned.mlir:2:42
  input  [1:0]  sel_i,	// /tmp/tmp.5zXO9qCSQw/11258_OpenABC_leaf_level_verilog_gf12_bp_quad_bsg_mux_width_p16_els_p4.cleaned.mlir:2:60
  output [15:0] data_o	// /tmp/tmp.5zXO9qCSQw/11258_OpenABC_leaf_level_verilog_gf12_bp_quad_bsg_mux_width_p16_els_p4.cleaned.mlir:2:77
);

  wire _GEN;	// /tmp/tmp.5zXO9qCSQw/11258_OpenABC_leaf_level_verilog_gf12_bp_quad_bsg_mux_width_p16_els_p4.cleaned.mlir:157:12
  wire _GEN_0;	// /tmp/tmp.5zXO9qCSQw/11258_OpenABC_leaf_level_verilog_gf12_bp_quad_bsg_mux_width_p16_els_p4.cleaned.mlir:155:12
  wire N2;	// /tmp/tmp.5zXO9qCSQw/11258_OpenABC_leaf_level_verilog_gf12_bp_quad_bsg_mux_width_p16_els_p4.cleaned.mlir:153:12
  assign N2 = ~(sel_i[0]) & ~(sel_i[1]);	// /tmp/tmp.5zXO9qCSQw/11258_OpenABC_leaf_level_verilog_gf12_bp_quad_bsg_mux_width_p16_els_p4.cleaned.mlir:149:12, :150:12, :151:12, :152:12, :153:12
  assign _GEN_0 = ~(sel_i[0]) & sel_i[1];	// /tmp/tmp.5zXO9qCSQw/11258_OpenABC_leaf_level_verilog_gf12_bp_quad_bsg_mux_width_p16_els_p4.cleaned.mlir:149:12, :150:12, :152:12, :155:12
  assign _GEN = sel_i[0] & ~(sel_i[1]);	// /tmp/tmp.5zXO9qCSQw/11258_OpenABC_leaf_level_verilog_gf12_bp_quad_bsg_mux_width_p16_els_p4.cleaned.mlir:149:12, :150:12, :151:12, :157:12
  assign data_o =
