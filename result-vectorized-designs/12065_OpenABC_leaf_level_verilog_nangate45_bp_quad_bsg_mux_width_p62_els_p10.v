...
module bsg_mux_width_p62_els_p10(	// /tmp/tmp.1v2ROBinZ2/12065_OpenABC_leaf_level_verilog_nangate45_bp_quad_bsg_mux_width_p62_els_p10.cleaned.mlir:2:3
  input  [619:0] data_i,	// /tmp/tmp.1v2ROBinZ2/12065_OpenABC_leaf_level_verilog_nangate45_bp_quad_bsg_mux_width_p62_els_p10.cleaned.mlir:2:43
  input  [3:0]   sel_i,	// /tmp/tmp.1v2ROBinZ2/12065_OpenABC_leaf_level_verilog_nangate45_bp_quad_bsg_mux_width_p62_els_p10.cleaned.mlir:2:62
  output [61:0]  data_o	// /tmp/tmp.1v2ROBinZ2/12065_OpenABC_leaf_level_verilog_nangate45_bp_quad_bsg_mux_width_p62_els_p10.cleaned.mlir:2:79
);

  wire _sel_i_1;	// /tmp/tmp.1v2ROBinZ2/12065_OpenABC_leaf_level_verilog_nangate45_bp_quad_bsg_mux_width_p62_els_p10.cleaned.mlir:12:10
  wire _sel_i_0;	// /tmp/tmp.1v2ROBinZ2/12065_OpenABC_leaf_level_verilog_nangate45_bp_quad_bsg_mux_width_p62_els_p10.cleaned.mlir:11:10
  wire _sel_i_2;	// /tmp/tmp.1v2ROBinZ2/12065_OpenABC_leaf_level_verilog_nangate45_bp_quad_bsg_mux_width_p62_els_p10.cleaned.mlir:10:10
  wire _sel_i_3;	// /tmp/tmp.1v2ROBinZ2/12065_OpenABC_leaf_level_verilog_nangate45_bp_quad_bsg_mux_width_p62_els_p10.cleaned.mlir:9:10
  wire N25 = ~_sel_i_3 & ~_sel_i_2 & ~_sel_i_0 & ~_sel_i_1;	// /tmp/tmp.1v2ROBinZ2/12065_OpenABC_leaf_level_verilog_nangate45_bp_quad_bsg_mux_width_p62_els_p10.cleaned.mlir:4:10, :5:10, :6:10, :7:10, :8:10, :9:10, :10:10, :11:10, :12:10
  assign _sel_i_3 = sel_i[3];	// /tmp/tmp.1v2ROBinZ2/12065_OpenABC_leaf_level_verilog_nangate45_bp_quad_bsg_mux_width_p62_els_p10.cleaned.mlir:9:10
  assign _sel_i_2 = sel_i[2];	// /tmp/tmp.1v2ROBinZ2/12065_OpenABC_leaf_level_verilog_nangate45_bp_quad_bsg_mux_width_p62_els_p10.cleaned.mlir:10:10
  assign _sel_i_0 = sel_i[0];	// /tmp/tmp.1v2ROBinZ2/12065_OpenABC_leaf_level_verilog_nangate45_bp_quad_bsg_mux_width_p62_els_p10.cleaned.mlir:11:10
  assign _sel_i_1 = sel_i[1];	// /tmp/tmp.1v2ROBinZ2/12065_OpenABC_leaf_level_verilog_nangate45_bp_quad_bsg_mux_width_p62_els_p10.cleaned.mlir:12:10
  wire N26 = _sel_i_3 & ~_sel_i_0;	// /tmp/tmp.1v2ROBinZ2/12065_OpenABC_leaf_level_verilog_nangate45_bp_quad_bsg_mux_width_p62_els_p10.cleaned.mlir:5:10, :9:10, :11:10, :14:11
  wire N27 = ~_sel_i_3 & ~_sel_i_2 & _sel_i_0 & ~_sel_i_1;	// /tmp/tmp.1v2ROBinZ2/12065_OpenABC_leaf_level_verilog_nangate45_bp_quad_bsg_mux_width_p62_els_p10.cleaned.mlir:4:10, :6:10, :7:10, :9:10, :10:10, :11:10, :12:10, :18:11
  wire N29 = ~_sel_i_2 & ~_sel_i_0 & _sel_i_1;	// /tmp/tmp.1v2ROBinZ2/12065_OpenABC_leaf_level_verilog_nangate45_bp_quad_bsg_mux_width_p62_els_p10.cleaned.mlir:5:10, :6:10, :10:10, :11:10, :12:10, :21:11
  wire N30 = ~_sel_i_2 & _sel_i_0 & _sel_i_1;	// /tmp/tmp.1v2ROBinZ2/12065_OpenABC_leaf_level_verilog_nangate45_bp_quad_bsg_mux_width_p62_els_p10.cleaned.mlir:6:10, :10:10, :11:10, :12:10, :23:11
  wire N31 = _sel_i_2 & ~_sel_i_0 & ~_sel_i_1;	// /tmp/tmp.1v2ROBinZ2/12065_OpenABC_leaf_level_verilog_nangate45_bp_quad_bsg_mux_width_p62_els_p10.cleaned.mlir:4:10, :5:10, :10:10, :11:10, :12:10, :26:11
  wire _GEN = _sel_i_2 & _sel_i_0;	// /tmp/tmp.1v2ROBinZ2/12065_OpenABC_leaf_level_verilog_nangate45_bp_quad_bsg_mux_width_p62_els_p10.cleaned.mlir:10:10, :11:10, :27:11
  wire N32 = _GEN & ~_sel_i_1;	// /tmp/tmp.1v2ROBinZ2/12065_OpenABC_leaf_level_verilog_nangate45_bp_quad_bsg_mux_width_p62_els_p10.cleaned.mlir:4:10, :12:10, :27:11, :29:11
  wire N33 = _sel_i_2 & ~_sel_i_0 & _sel_i_1;	// /tmp/tmp.1v2ROBinZ2/12065_OpenABC_leaf_level_verilog_nangate45_bp_quad_bsg_mux_width_p62_els_p10.cleaned.mlir:5:10, :10:10, :11:10, :12:10, :31:11
  wire N34 = _GEN & _sel_i_1;	// /tmp/tmp.1v2ROBinZ2/12065_OpenABC_leaf_level_verilog_nangate45_bp_quad_bsg_mux_width_p62_els_p10.cleaned.mlir:12:10, :27:11, :32:11
  wire N28 = _sel_i_3 & _sel_i_0;	// /tmp/tmp.1v2ROBinZ2/12065_OpenABC_leaf_level_verilog_nangate45_bp_quad_bsg_mux_width_p62_els_p10.cleaned.mlir:9:10, :11:10, :33:11
  assign data_o =
    {N25
       ? data_i[61]
       : N27
