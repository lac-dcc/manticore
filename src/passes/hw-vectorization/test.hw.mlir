module {
  ...
  hw.module @test_multiple_patterns_reverse(in %a : i4, in %b : i4, out out_xor : i4) {
    ...
    %13 = comb.extract %b from 1 : (i4) -> i1
    %14 = comb.xor %12, %13 : i1
    %15 = comb.extract %a from 1 : (i4) -> i1
    %16 = comb.extract %b from 2 : (i4) -> i1
    %17 = comb.xor %15, %16 : i1
  ...
  hw.module @ShuffledXOR(in %a : i4, in %b : i4, out out : i4) {
    ...
    %c0_i3 = hw.constant 0 : i3
    %0 = comb.concat %c0_i3, %13 : i3, i1
    %1 = comb.concat %c0_i2, %12, %false : i2, i1, i1
    %2 = comb.or %1, %0 : i4
    %3 = comb.and %2, %c-5_i4 : i4
    ...
    %7 = comb.concat %10, %c0_i3 : i1, i3
    %8 = comb.or %7, %6 : i4
    %9 = comb.xor %a, %b {sv.namehint = "temp"} : i4
    %10 = comb.extract %9 from 0 : (i4) -> i1
    %11 = comb.extract %9 from 2 : (i4) -> i1
  ...
  hw.module @VectorizedEnable(in %a : i4, in %enable : i4, out o : i4) {
    ...
    %8 = comb.or %7, %6 : i4
    %9 = comb.extract %a from 3 : (i4) -> i1
    %10 = comb.extract %enable from 3 : (i4) -> i1
    %11 = comb.and %9, %10 : i1
    %12 = comb.extract %a from 2 : (i4) -> i1
    %13 = comb.extract %enable from 2 : (i4) -> i1
    %14 = comb.and %12, %13 : i1
    %15 = comb.extract %a from 1 : (i4) -> i1
    %16 = comb.extract %enable from 1 : (i4) -> i1
    %17 = comb.and %15, %16 : i1
    %18 = comb.extract %a from 0 : (i4) -> i1
    %19 = comb.extract %enable from 0 : (i4) -> i1
  ...
  hw.module @ShiftAndXOR(in %a : i4, in %b : i4, out out : i4) {
    ...
    %8 = comb.or %7, %6 : i4
    %9 = comb.extract %a from 3 : (i4) -> i1
    %10 = comb.extract %b from 2 : (i4) -> i1
    %11 = comb.xor %9, %10 : i1
    %12 = comb.extract %a from 2 : (i4) -> i1
    %13 = comb.extract %b from 1 : (i4) -> i1
    %14 = comb.xor %12, %13 : i1
    %15 = comb.extract %a from 1 : (i4) -> i1
    %16 = comb.extract %b from 0 : (i4) -> i1
    %17 = comb.xor %15, %16 : i1
    %18 = comb.extract %a from 0 : (i4) -> i1
    hw.output %8 : i4
  }
  ...
  hw.module @CarryChainAdder(in %a : i4, in %b : i4, out sum : i4) {
    ...
    %c-5_i4 = hw.constant -5 : i4
    %c0_i3 = hw.constant 0 : i3
    %0 = comb.concat %c0_i3, %17 : i3, i1
    %1 = comb.concat %c0_i2, %22, %false : i2, i1, i1
    %2 = comb.or %1, %0 : i4
    %3 = comb.and %2, %c-5_i4 : i4
    %4 = comb.concat %false, %30, %c0_i2 : i1, i1, i2
    %5 = comb.or %4, %3 : i4
    %6 = comb.and %5, %c7_i4 : i4
    %7 = comb.concat %38, %c0_i3 : i1, i3
    %8 = comb.or %7, %6 : i4
    %9 = comb.concat %26, %false : i1, i1
    %10 = comb.concat %false, %18 : i1, i1
    %11 = comb.or %9, %10 : i2
    %12 = comb.concat %34, %c0_i2 : i1, i2
    %13 = comb.concat %false, %11 : i1, i2
    %14 = comb.or %12, %13 : i3
    %15 = comb.extract %a from 0 : (i4) -> i1
    %16 = comb.extract %b from 0 : (i4) -> i1
    %17 = comb.xor %15, %16 : i1
    %18 = comb.and %15, %16 : i1
    %19 = comb.extract %a from 1 : (i4) -> i1
    %20 = comb.extract %b from 1 : (i4) -> i1
    %21 = comb.extract %14 from 0 : (i3) -> i1
    %22 = comb.xor %19, %20, %21 : i1
    %23 = comb.and %19, %20 : i1
    %24 = comb.and %19, %21 : i1
    %25 = comb.and %20, %21 : i1
    %26 = comb.or %23, %24, %25 : i1
    %27 = comb.extract %a from 2 : (i4) -> i1
    %28 = comb.extract %b from 2 : (i4) -> i1
    %29 = comb.extract %14 from 1 : (i3) -> i1
    %30 = comb.xor %27, %28, %29 : i1
    %31 = comb.and %27, %28 : i1
    %32 = comb.and %27, %29 : i1
    %33 = comb.and %28, %29 : i1
    %34 = comb.or %31, %32, %33 : i1
    %35 = comb.extract %a from 3 : (i4) -> i1
    %36 = comb.extract %b from 3 : (i4) -> i1
    %37 = comb.extract %14 from 2 : (i3) -> i1
    %38 = comb.xor %35, %36, %37 : i1
    hw.output %8 : i4
  }
  ...
  hw.module @raw_example(in %in : i4, out out : i4) {
    ...
    %c-5_i4 = hw.constant -5 : i4
    %c0_i3 = hw.constant 0 : i3
    %0 = comb.concat %c0_i3, %14 : i3, i1
    %1 = comb.concat %c0_i2, %13, %false : i2, i1, i1
    %2 = comb.or %1, %0 : i4
    %3 = comb.and %2, %c-5_i4 : i4
    %4 = comb.concat %false, %12, %c0_i2 : i1, i1, i2
    %5 = comb.or %4, %3 : i4
    ...
    %8 = comb.or %7, %6 : i4
    %9 = comb.extract %in from 3 : (i4) -> i1
    %10 = comb.extract %8 from 3 : (i4) -> i1
    %11 = comb.extract %in from 2 : (i4) -> i1
    %12 = comb.and %10, %11 : i1
    %13 = comb.extract %in from 1 : (i4) -> i1
    %14 = comb.extract %in from 0 : (i4) -> i1
    hw.output %8 : i4
  }
  hw.module @cross_dependency(in %in : i2, out out : i2) {
    %false = hw.constant false
    %0 = comb.concat %false, %5 : i1, i1
    %1 = comb.concat %8, %false : i1, i1
    %2 = comb.or %1, %0 : i2
    %3 = comb.extract %in from 0 : (i2) -> i1
    %4 = comb.extract %2 from 1 : (i2) -> i1
    %5 = comb.xor %3, %4 : i1
    %6 = comb.extract %in from 1 : (i2) -> i1
    %7 = comb.extract %2 from 0 : (i2) -> i1
    %8 = comb.xor %6, %7 : i1
    hw.output %2 : i2
  }
}
